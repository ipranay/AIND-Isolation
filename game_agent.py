...
def custom_score(game, player):
    ...
    if my_moves == 0 and opp_moves > 0:
        ...
        return float("-inf")
    if my_moves == 0 and opp_moves == 0:
        # It's a draw, but we want to win, so send a negative value
        return -1
...
class CustomPlayer:
    ...
    def get_move(self, game, legal_moves, time_left):
        ...
        # convert string to callable method
        ...
        # good_first_moves = { (2,2), (0,1), (0,2), (0,3), (1,0), (2,0), (3,0), (4,1), (4,2), (4,3), (1,4), (2,4), (3,4) }
        # good_legal_moves = good_first_moves & set(legal_moves)
        # if good_legal_moves:
        #     return list(good_legal_moves)[0]
        ...
        try:
            ...
            if self.iterative:
                depth = 1
                while 1:
                    if self.search_depth > 0 and depth > self.search_depth:
                        break
    ...
    def minimax(self, game, depth, maximizing_player=True):
        ...
        # send current score and location if we cant go deeper or no more legal moves are left
